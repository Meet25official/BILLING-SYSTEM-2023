...
def ProductForm(request):
    if 'org' in request.session:
        ...
        if request.POST:
            ...
            a=AddProduct.objects.get(Product_name=request.POST['Product_name'])
...
def ProductDelete(request,prod_del):
    if 'org' in request.session:
        ...
        a=AddProduct.objects.get(Product_name=data.Product_name)
...
def ProductUpdate(request,prod_up):
    if 'org' in request.session:
        ...
        a=AddProduct.objects.get(Product_name=prod.Product_name)
        xy=prod.Qty
